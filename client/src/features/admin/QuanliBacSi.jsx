  ...
  return (
    <div className="component-container">
      ...
      <table>
        <thead>
          <tr>
            <th style={{ width: '5%', color: '#000', fontWeight: 700 }}>ID</th>
            <th style={{ width: '20%', color: '#000', fontWeight: 700 }}>Tên Bác sĩ</th>
            <th style={{ width: '15%', color: '#000', fontWeight: 700 }}>Chuyên khoa</th>
            <th style={{ width: '60%', color: '#000', fontWeight: 700 }}>Lịch đã đăng ký (Ngày rảnh)</th>
          </tr>
        </thead>
        <tbody>
          {doctors.map((doc) => (
