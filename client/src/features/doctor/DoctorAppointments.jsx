...
function DoctorAppointments({ user, appointments, updateAppointment }) {
    ...
    // Cập nhật localAppointments khi appointments thay đổi
    useEffect(() => {
    ...
    const myAppointments = localAppointments.filter(app => 
    ...
    return (
        <div className="component-container">
            ...
            <p>Bác sĩ: <strong>{user.full_name || user.name}</strong></p>

            {myAppointments.length === 0 ? (
                <p style={{fontStyle:'italic', color:'#777', textAlign: 'center', padding: '40px'}}>Chưa có bệnh nhân nào đặt lịch.</p>
            ) : (
