...
import { FaHospitalSymbol, FaHistory, FaCalendarPlus, FaUserMd, FaNotesMedical, FaCheckCircle, FaStar, FaStethoscope,
                ...
                {view === 'history' && (
                    <div className="history-container">
                        ...
                        <table className="history-table">
                            ...
                            <tbody>
                                {user && appointments.filter(a => a.patientName === user.full_name).map(app => {
